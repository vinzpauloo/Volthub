...
export const products: Product[] = [
  ...
  {
    id: "ev-charging-32",
    name: "IP Design AC EV Charger",
    subtitle: "Compact 7kW AC charger with NFC and LED display",
    category: "ev-charging",
    tag: "Single-gun AC Charging Pile",
    image: "/Product/EV/ip-design/main.jpg",
    images: [
      "/Product/EV/ip-design/main.jpg",
      "/Product/EV/ip-design/angle.jpg",
      "/Product/EV/ip-design/specs.jpg",
    ],
    layout: "ev",
    description: "ZD01-32A — 7kW portable AC EV charger with Type 2 connector. NFC-enabled with LED display showing real-time charging data. IP65-rated for indoor and outdoor use. Adjustable current from 8A to 32A. Supports portable, wall-mounted, and column-mounted installation.",
  },
  {
    id: "ev-charging-box",
    name: "Wall Charger Box",
    subtitle: "Premium cold rolled steel enclosure for EV chargers",
    category: "ev-charging",
    tag: "EV Charger Accessory",
    image: "/Product/EV/wall-charger-box/main.jpg",
    images: [
      "/Product/EV/wall-charger-box/main.jpg",
      "/Product/EV/wall-charger-box/medium.jpg",
      "/Product/EV/wall-charger-box/specs.jpg",
    ],
    layout: "ev",
    description: "Premium cold rolled steel wall charger box designed to house and protect EV charging equipment. IP65-rated weatherproof, dustproof, and rainproof enclosure available in two sizes: Medium (66×45×25cm) and Large (80×50×25cm).",
  },
...
export const productDetails: Record<string, {
  ...
  "ev-charging-32": {
    description: "ZD01-32A — 7kW portable AC EV charger with Type 2 connector. NFC-enabled with LED display showing real-time charging data including electricity (kWh), temperature, current, and voltage. IP65-rated for indoor and outdoor use with high-strength ABS material construction. Adjustable current from 8A to 32A with auto power-off when charging is complete. Supports portable, wall-mounted, and column-mounted installation. Equipped with multiple safety protections and emergency stop switch.",
    variations: [
      { name: "Model", value: "ZD01-32A" },
      { name: "Type", value: "Portable AC EV Charger" },
      { name: "Rated Power", value: "7kW" },
      { name: "Connector Type", value: "Type 2 (IEC 62196)" },
      { name: "Rated Current", value: "32A (Adjustable 8A–32A)" },
      { name: "Cable Length", value: "5m / 10m (optional)" },
      { name: "Installation Method", value: "Portable / Wall mounted / Column mounted" },
      { name: "Charging Mode", value: "Plug and charge, RFID card" },
    ],
    specifications: [
      { label: "Model", value: "ZD01-32A" },
      { label: "Rated Power", value: "7kW" },
      { label: "Rated Current", value: "32A (Adjustable 8A–32A)" },
      { label: "Rated Input/Output Voltage", value: "AC 220V ±10%" },
      { label: "Cable Length", value: "5m / 10m (optional)" },
      { label: "Appointment Time", value: "0H / 2H / 4H / 6H / 8H" },
      { label: "Protection Grade", value: "IP65" },
      { label: "Installation Method", value: "Portable / Wall mounted / Column mounted" },
      { label: "Operating Temperature", value: "-20°C ~ +50°C" },
      { label: "Humidity", value: "5% ~ 95%" },
      { label: "LED Display", value: "Real-time kWh, temperature (°C), current (A), voltage (V), charging status" },
      { label: "Safety Functions", value: "Low-voltage, high-voltage, over-current, high-temperature protection, grounding" },
      { label: "Standards", value: "EN 61851-1:2011, EN IEC 62196-2" },
      { label: "Safety Device", value: "Emergency stop switch" },
      { label: "Charging Current", value: "Adaptive matching according to vehicle" },
      { label: "Charging Mode", value: "Plug and charge, RFID card" },
      { label: "Mechanical Lifespan", value: ">10,000 insertion/extraction cycles" },
      { label: "Cooling Method", value: "Natural air cooling" },
    ],
    features: [
      "Max 32A fast charging for all Type 2 electric vehicles",
      "Plug and charge convenience with European standard plug",
      "IP65-rated for water resistance, suitable for indoor and outdoor use",
      "Multiple safety features: UL-certified charging cable and plug",
      "Strong and durable construction with high-strength ABS material",
      "Temperature monitoring for safe charging and prevention of accidents",
      "Auto power-off when charging is complete",
      "NFC-enabled for contactless authentication",
      "LED display showing real-time charging data (kWh, temperature, current, voltage)",
      "Adjustable current from 8A to 32A for flexible charging speeds",
      "Scheduled charging with appointment timer (0–8 hours)",
      "Emergency stop switch for immediate safety cutoff",
      "Adaptive current matching based on vehicle requirements",
      "Includes: charging station, charging gun, instruction manual, gun stock, mounting plate, mounting nail, storage bag",
    ],
  },
  "ev-charging-box": {
    description: "Premium cold rolled steel wall charger box designed to house and protect EV charging equipment. IP65-rated weatherproof, dustproof, and rainproof enclosure. Available in two sizes to accommodate different charger configurations. Built for long-term outdoor deployment with robust material and finish.",
    variations: [
      {
        name: "Medium",
        value: "66 × 45 × 25 cm",
        description: "Medium size enclosure suitable for standard residential chargers",
        image: "/Product/EV/wall-charger-box/medium.jpg",
      },
      {
        name: "Large",
        value: "80 × 50 × 25 cm",
        description: "Large size enclosure for commercial-grade chargers",
        image: "/Product/EV/wall-charger-box/main.jpg",
      },
      { name: "Material", value: "Premium Cold Rolled Steel" },
      { name: "Protection Grade", value: "IP65" },
    ],
    specifications: [
      { label: "Material", value: "Premium Cold Rolled Steel" },
      { label: "Protection Grade", value: "IP65" },
      { label: "Size (Medium)", value: "66 × 45 × 25 cm" },
      { label: "Size (Large)", value: "80 × 50 × 25 cm" },
      { label: "Weather Resistance", value: "Weatherproof, dustproof, rainproof" },
      { label: "Type", value: "Wall-mounted enclosure" },
    ],
    features: [
      "Premium cold rolled steel construction for durability",
      "IP65-rated for complete dust and water protection",
      "Weatherproof, dustproof, and rainproof design",
      "Two size options: Medium (66×45×25cm) and Large (80×50×25cm)",
      "Wall-mounted installation for space efficiency",
      "Designed to house and protect EV charging equipment",
      "Suitable for outdoor and exposed environments",
      "Clean, professional appearance for residential and commercial settings",
    ],
  },
  "solar-street-rklv02": {

...
import { evChargingData } from "./insights-data";
import InsightChart from "./insight-chart";

const EvChargingSection = (): React.ReactElement => {
  const { badge, title, description, keyStats, growthData, highlights, chartType, chartColor, chartTitle } =
    evChargingData;

  return (
    <section className="py-16 border-t border-gray-100">
      <span className="inline-flex items-center rounded-full bg-emerald-100 px-3 py-1 text-xs font-semibold text-emerald-800 mb-4">
        {badge}
      </span>

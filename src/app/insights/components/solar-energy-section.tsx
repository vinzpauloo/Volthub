...
import { solarEnergyData } from "./insights-data";
import InsightChart from "./insight-chart";

const SolarEnergySection = (): React.ReactElement => {
  ...
  return (
    <section className="py-16 border-t border-gray-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
        <div className="order-2 lg:order-1 rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
          <InsightChart
